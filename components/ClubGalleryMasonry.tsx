...
const galleryImages = [
  { src: '/assets/images/club1.jpg', alt: 'Club event' },
  { src: '/assets/images/club2.jpg', alt: 'Club event' },
  { src: '/assets/images/club3.jpg', alt: 'Club event' },
  { src: '/assets/images/club4.jpg', alt: 'Club event' },
];

export default function ClubGalleryMasonry() {
  ...
  return (
    <section ref={sectionRef} className="py-16 bg-dark-500 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 relative z-10">
        <div className="text-center mb-12">
          <p className="text-sm uppercase tracking-wider text-primary-500 mb-4 font-semibold">CLUB VIBES</p>
          <h2 className="text-2xl sm:text-5xl lg:text-6xl font-bold mb-4 text-white">
            Experience the Energy
          </h2>
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            See the energy and excitement we bring to club events and nightlife venues.
          </p>
        </div>

        {/* Mobile Layout - unchanged */}
        <div className="lg:hidden space-y-3 sm:space-y-6">
          {/* First row - 65/35 split on mobile */}
          ...
          {/* Second row - reversed order - 35/65 split on mobile */}
          <div className="flex sm:grid sm:grid-cols-12 gap-2 sm:gap-4">
            {galleryImages.slice(2, 4).reverse().map((image, index) => (
              <div
                key={index + 2}
